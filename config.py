...
parser.add_argument('--gpu_id', type=list,default=[0,3], help='use cpu only')
...
parser.add_argument('--xy_down_scale', type=float, default=128, help='')#
parser.add_argument('--slice_down_scale', type=float, default=48, help='')#
parser.add_argument('--valid_rate', type=float, default=0.2, help='')

# # # # data in/out and dataset
parser.add_argument('--dataset_path',default = './LITS2017/fixed_data',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = './LITS2017/test_data',help='Testset path')

# parser.add_argument('--dataset_path',default = './Fixed_LITS',help='fixed trainset root path')
# parser.add_argument('--test_data_path',default = './Fixed_LITS/test_data',help='Testset path')

# parser.add_argument('--dataset_path',default = './Fixed_LITS-liver-label',help='fixed trainset root path')
# parser.add_argument('--test_data_path',default = './Fixed_LITS/test_data',help='Testset path')

# parser.add_argument('--dataset_path',default = './Fixed_LITS-cancer-label',help='fixed trainset root path')
# parser.add_argument('--test_data_path',default = './Fixed_LITS/test_data',help='Testset path')#
#
# parser.add_argument('--dataset_path',default = './petct_Fixed_LITS-liver-label',help='fixed trainset root path')
# parser.add_argument('--test_data_path',default = './Fixed_LITS/test_data',help='Testset path')

# parser.add_argument('--dataset_path',default = './HEAD-NECK-HN1-raw_data/fixed_fusion_data',help='fixed trainset root path')
# parser.add_argument('--test_data_path',default = './HEAD-NECK-HN1-raw_data/fixed_fusion_data',help='Testset path')
...
parser.add_argument('--train_image_type',type = list,default=[("pet-ct-image","pet-ct-seg"),("ct-image","ct-seg"),("pet-image","pet-seg")])
# 新增
